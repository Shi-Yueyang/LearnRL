...
class Track:
    ...
    def get_current_properties(self, train_position=None):
        """
        Get current track properties, optionally updating position first.
        
        Args:
            train_position (float, optional): Train's absolute position to update to
        
        Returns:
            dict: Current gradient, curve_radius, friction, and other coefficients
        """
        # Auto-update position if provided
